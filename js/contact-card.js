...
const contactIconRow1 = createElement({
    cName: 'row',
    parent: contactBody,
})
...
const facebook = createElement({
    ...
    parent: contactIconRow1,
    eId: 'fbIcon',
    text: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 46.57 87.14"><defs><style>.cls-1{fill:#231f20;fill-rule:evenodd;}</style></defs><g id="Layer_2" data-name="Layer 2"><g id="Objects"><path id="LOGO" class="cls-1" d="M43.52,48.91l2.41-15.73H30.83V23c0-4.3,2.11-8.5,8.88-8.5h6.86V1.06A83.94,83.94,0,0,0,34.39,0C22,0,13.82,7.53,13.82,21.18v12H0V48.91H13.82V87.14h17V48.91Z"/></g></g></svg>'
})
